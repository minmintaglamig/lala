<x-app-layout>
    <div class="container p-4 mt-5 bg-white rounded shadow">
        ...
        <form action="{{ route('drivers.store.drivermoreinfo', $driver->driver_id) }}" method="POST"
            ...
            <div class="mb-4 card">
                ...
                <div class="card-body row">
                    <div class="mb-2 col-md-6"><strong>Full Name:</strong> {{ $driver->last_name }}, {{
                        $driver->first_name }} {{ $driver->middle_name }} {{ $driver->suffix }}</div>
                    <div class="mb-2 col-md-6"><strong>Contact:</strong> {{ $driver->contact_number }}</div>
            ...
            <div class="gap-2 mt-4 d-flex">
                ...
                <a href="{{ url('/vehicles/assign/' . $driver->driver_id) }}"
                    class="btn btn-outline-primary">Vehicle</a>
            </div>
        </form>
    </div>
