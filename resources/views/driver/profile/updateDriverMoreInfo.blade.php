    ...
    <form action="{{ route('driver.profile.updateDriverMoreInfo') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="p-4 rounded bg-blue-50">
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div><strong>Full Name:</strong> {{ $driver->name }}, {{ $driver->first_name }} {{ $driver->middle_name
                    }} {{ $driver->suffix }}</div>
        ...
        <div>
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div class="col-span-2">
                    ...
                    <img src="{{ asset('storage/' . $driver->license_image) }}" class="w-40 h-auto mt-2 border rounded">
                    @endif
                </div>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div>
                    ...
                    <input type="text" name="user_id" class="form-control" value="{{ $driver->user_id }}" readonly>
        ...
        <div class="flex mt-6 space-x-4">
            <button type="submit" class="px-6 py-2 text-black bg-green-600 rounded hover:bg-green-700">Save Driver
                Info</button>
            <a href="{{ url('/vehicles/assign/' . $driver->driver_id) }}"
                class="px-6 py-2 text-blue-500 border border-blue-500 rounded hover:bg-blue-50">Vehicle</a>
        </div>
    </form>
</div>
