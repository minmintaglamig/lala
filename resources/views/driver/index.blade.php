<x-app-layout>
    ...
    <div class="container p-4 bg-white rounded shadow">
        ...
        <!-- Filter Form -->
        <form method="GET" action="{{ route('driver.index') }}" class="mb-4 row g-3">
            <div class="col-md-4">
            ...
            <div class="gap-2 col-md-4 d-flex">
                ...
                <a href="{{ route('driver.index') }}" class="btn btn-secondary">Reset</a>
            </div>
        </form>
        ...
        <a href="{{ route('driver.create.driverinfo') }}" class="btn btn-primary">Add New Driver</a>
    </div>
